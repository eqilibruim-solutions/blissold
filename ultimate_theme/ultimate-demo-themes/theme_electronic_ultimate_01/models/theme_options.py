...
class ThemeElectronicUltimate01_Ultimate(models.AbstractModel):
    _inherit = 'theme.utils'

    def _theme_electronic_ultimate_01_post_copy(self, mod):
        ...
        self.enable_view('customize_theme_business.option_nav_transparent_font_primary')
