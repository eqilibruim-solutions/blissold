...
class ThemeRestaurantEcommerceUltimate02_Ultimate(models.AbstractModel):
    _inherit = 'theme.utils'

    def _theme_restaurant_ecommerce_ultimate_02_post_copy(self, mod):
        self.enable_view('customize_theme_business.option_header_2')
        ...
        # self.enable_view('website.option_font_body_04_variables')
