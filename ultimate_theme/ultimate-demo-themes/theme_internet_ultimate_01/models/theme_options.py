...
class ThemeInternetUltimate01_Ultimate(models.AbstractModel):
    _inherit = 'theme.utils'

    def _theme_internet_ultimate_01_post_copy(self, mod):
        ...
        # self.enable_view('website.option_font_navbar_03_variables')
