...
class ThemeCharityUltimate01_Ultimate(models.AbstractModel):
    _inherit = 'theme.utils'

    def _theme_charity_ultimate_01_post_copy(self, mod):
        ...
        self.enable_view('customize_theme_business.option_mid_header_6')
        self.enable_view('customize_theme_business.option_layout_default_container_variables')
        self.enable_view('customize_theme_business.option_nav_pils_round')
