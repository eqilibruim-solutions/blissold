...
class ThemeVetUltimate01_Ultimate(models.AbstractModel):
    _inherit = 'theme.utils'

    def _theme_vet_ultimate_01_post_copy(self, mod):
        ...
        self.enable_view('customize_theme_business.option_nav_pils_square')
