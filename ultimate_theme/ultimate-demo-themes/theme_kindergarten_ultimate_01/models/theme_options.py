...
class ThemeKindergartenUltimate01_Ultimate(models.AbstractModel):
    _inherit = 'theme.utils'

    def _theme_kindergarten_ultimate_01_post_copy(self, mod):
        ...
        self.enable_view('customize_theme_business.option_mid_header_1')
