...
class ThemeCosmeticsEcommerceUltimate01_Ultimate(models.AbstractModel):
    _inherit = 'theme.utils'

    def _theme_cosmetics_ecommerce_ultimate_01_post_copy(self, mod):
        ...
        # self.enable_view('customize_theme_ecommerce.option_mid_header_default')
