odoo.define('bliss.best_sellers', function (require) {
...
publicWidget.registry.productsBestSellersSnippet = publicWidget.Widget.extend({
    selector: '.s_products_best_selllers',
    xmlDependencies: ['/bliss/static/src/xml/product_best_sellers.xml','/bliss/static/src/xml/website_best_seller.xml'],
    ...
    init: function () {
        ...
        this.uniqueId = _.uniqueId('o_carousel_best_sellers_products_');
    ...
    _fetch: function () {
        ...
        return this._rpc({
            route: '/shop/products/best_sellers',
        }).then(res => {
    ...
    _render: function (res) {
        ...
        this.mobileCarousel = $(qweb.render('bliss.productsBestSeller', {
            uniqueId: this.uniqueId,
            productFrame: 1,
            productsGroups: mobileProducts,
        }));
        this.webCarousel = $(qweb.render('bliss.productsBestSeller', {
            uniqueId: this.uniqueId,
            productFrame: 3,
